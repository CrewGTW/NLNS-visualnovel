...
screen say(who, what):
    ...
    if not renpy.variant("small"):
        add SideImage() xalign 0.0 yalign 1.0 maxsize(400,400)
...
## Disclaimer acreen ###########################################################
##
##  This screen shows disclaimer text

# screen disclaimer():
    # text "Дисклеймер" size 40
    # text "Данная игра полностью аполитична и не несёт в себе цели оскорбить, задеть или агитировать игроков. Любые совпадения с реальными людьми и событиями случайны, либо употреблены в шуточном контексте."
    # text "Это лёгкая и незатейливая история с несколькими вариантами развития событий, призванная высмеять серьёзные каноны такого популярного явления как попаданчество. Вместе с главным героем вам предстоит путь от буквально одной невинной оплошности до вполне волнующего финала, ведь в процессе задача расслабленно провести время в игре претерпит серьёзные изменения, ставя на кон не только получение удовольствия от игрового процесса, но и нечто большее. Если вас всегда интересовал вопрос: \"Как же вести себя на сошедшем с ума сервере\", то \"Неудачник без Скилла\" станет для вас наглядным пособием!"
    # text "Удачи в игре!"
